...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mt-12 mb-12 relative">
    <article>
            ...
            <a href="{{ route('activity.indexActivity') }}"><h2 class="flex tracking-wider text-gray-500 items-center" data-aos="fade-down" data-aos-delay="300">{{ __('更多') }}<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mt-12" data-aos="fade-up" data-aos-delay="100">
  <article>
            ...
            <a href="{{ route('car' ) }}"><h2 class="flex tracking-wider text-gray-500 items-center">{{ __('更多') }}<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L14.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
              <path fill-rule="evenodd" d="M4.293 15.707a1 1 0 010-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
            </svg></h2></a>
            </div>
  ...
  <div class="">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
        ...
        <a href="{{ route('posts' ) }}"><h2 class="flex tracking-wider text-gray-500 items-center" data-aos="fade-left" data-aos-delay="300">{{ __('更多') }}<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L14.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
          <path fill-rule="evenodd" d="M4.293 15.707a1 1 0 010-1.414L8.586 10 4.293 5.707a1 1 0 011.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
        </svg></h2></a>
        </div>
